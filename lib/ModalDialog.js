...
var ModalDialog = (function (_React$Component) {
  ...
  function ModalDialog() {
    ...
    this.render = function () {
      ...
      var _props$buttons = _props.buttons;
      var buttons = _props$buttons === undefined ? [] : _props$buttons;

      var rest = _objectWithoutProperties(_props, ['children', 'className', 'componentIsLeaving', 'left', 'leftOffset', 'margin', 'onClose', 'recenter', 'style', 'top', 'topOffset', 'width', 'dismissOnBackgroundClick', 'buttons']);
      ...
      return _react2['default'].createElement(
        ...
        onClose || buttons.length > 0 ? _react2['default'].createElement(
          'div',
          { className: (0, _narcissus.inject)(styles.buttonsContainer) },
          onClose ? _react2['default'].createElement(
            _CircleButton2['default'],
            { onClick: onClose, diameter: DIAMETER, background: 'black' },
            _react2['default'].createElement(_CloseCircle2['default'], { diameter: DIAMETER })
          ) : null,
          buttons.map(function (button) {
            return _react2['default'].createElement(
              _CircleButton2['default'],
              { onClick: button.onClick, diameter: DIAMETER, background: button.background },
              button.icon
            );
          })
        ) : null,
